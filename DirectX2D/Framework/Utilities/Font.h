...
public:
    ...
    void RenderText(string text, Float2 pos, Float2 size = Float2(), bool leftAlign = false);
    void RenderText(wstring text, Float2 pos, Float2 size = Float2(), bool leftAlign = false);
