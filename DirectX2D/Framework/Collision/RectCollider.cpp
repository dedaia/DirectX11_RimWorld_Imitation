...
void RectCollider::SetLT(Vector2 sized)
{
    this->size = sized * 0.5;

    vertices[0].pos.x = -size.x;
    vertices[0].pos.y = +size.y;
}
void RectCollider::SetLB(Vector2 sized)
{
    this->size = sized * 0.5;
...
void RectCollider::SetRT(Vector2 sized)
{
    this->size = sized * 0.5;
...
void RectCollider::SetRB(Vector2 sized)
{
    this->size = sized * 0.5;
...
void RectCollider::Set_LB(Vector2 possize)
{
    size.x = possize.x * 0.5f;
    size.y = possize.y * 0.5f;
}
